...
if 0
    ...
    [Met,InitConc,BkgdConc] = ...
        InputInterp(Met,InitConc,BkgdConc,Jan26.Time,Time_interp,circularFlag);
...
x = Jan26.Time; % X - axis, minute of day
y1 = Jan26.O3; % Y1, Observed O3
...
title('Model Prediction, No VOCs, Jan26')
