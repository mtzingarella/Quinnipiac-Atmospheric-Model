...
if 0
    ...
    [Met,InitConc,BkgdConc] = ...
        InputInterp(Met,InitConc,BkgdConc,Feb09.Time,Time_interp,circularFlag);
...
x = Feb09.Time; % X - axis, minute of day
y1 = Feb09.O3; % Y1, Observed O3
...
title('Model Prediction, No VOCs, 26Jan')
