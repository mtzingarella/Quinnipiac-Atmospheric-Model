...
% mechanism and scaling J-values to a photoresistor output to estimate NO2
% photolysis. Scaling procedure/work in and excel workbook in the
% sharedrive
...
title('Model Prediction, No VOCs TUV, Sep16')
