%Added ethylene estimates using a range determined from 25th and 75th percentile of
%CalTech data and scaling the fluctuation in ethylene to the fluctuation in
%NO - under assumption that most NO/ethylene are coming from automobiles
...
title('Model Prediction, Add Ethylene, Sep16')
